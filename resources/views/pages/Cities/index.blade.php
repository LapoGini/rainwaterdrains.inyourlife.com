            ...
            <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <div class="flex-none">
                        ...
                        <a class="px-3 py-2 rounded bg-danger text-white" href="{{ route('cities.destroy', $city) }}" onclick="event.preventDefault(); if (confirm('Sei sicuro di voler eliminare questo comune?')) { document.getElementById('delete-form').submit(); }">
                            <i class="fa-solid fa-trash"></i>
                        </a>

                        <form id="delete-form" action="{{ route('cities.destroy', $city) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
